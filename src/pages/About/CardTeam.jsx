            ...
            <div className="card-body text-center">
              <div className="p-4 border radius-15">
                ...
                <div className="medsos mt-3 mb-3">
                  <a href="https://www.whatsapp.com/082340992450">
                    <AiOutlineWhatsApp />
                  </a>
                  <a href="https://instagram.com/abiem_houdini/" target="_blank" rel="noreferrer">
                    <GrInstagram />
                  </a>
                  <a href="https://www.linkedin.com/in/umi-uzli-aulia-29b493232/" target="_blank" rel="noreferrer">
                    <BsLinkedin />
                  </a>
                </div>
              </div>
          ...
          <div className="card radius-15">
            <div className="card-body text-center">
              <div className="p-4 border radius-15">
                ...
                <div className="medsos mt-3 mb-3">
                  <a href="https://instagram.com/miumy2805/" target="_blank" rel="noreferrer">
                    <GrInstagram />
                  </a>
                  <a href="https:///www.whatsapp.com/085337262535">
                    <AiOutlineWhatsApp />
                  </a>
                  <a href="https://www.linkedin.com/in/umi-uzli-aulia-29b493232/" target="_blank" rel="noreferrer">
                    <BsLinkedin />
